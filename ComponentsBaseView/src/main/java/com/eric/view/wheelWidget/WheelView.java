...
public class WheelView extends View{
    ...
    WheelAdapterInterf adapter;

    private String label;//附加单位
    int textSize;//选项的文字大小
    int textSizeCenter;//选项的文字大小
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textColorCenter = getResources().getColor(R.color.lj_color_black);
        dividerColor = getResources().getColor(R.color.lj_color_divider);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = getResources().getDimensionPixelSize(R.dimen.lj_textSize_xlarge);
        textSizeCenter = getResources().getDimensionPixelSize(R.dimen.lj_textSize_xxlarge);
...
//        customTextSize = getResources().getBoolean(R.bool.pickerview_customTextSize);
    ...
    private void initPaints() {
        ...
        paintIndicator.setStrokeWidth(DensityUtils.dip2px(context,1));
    ...
    public final void setTextSize(float size) {
        if (size > 0.0F && !customTextSize) {
            ...
            paintOuterText.setTextSize(textSize);
            paintCenterText.setTextSize(textSize+context.getResources().getDisplayMetrics().density*4);
            invalidate();
        }
    }
    ...
    public final void setAdapter(WheelAdapterInterf adapter) {
        this.adapter = adapter;
        remeasure();
        invalidate();
    }

    public final WheelAdapterInterf getAdapter() {
        return adapter;
    }
